...
def print_death_age(people_dict):
    ...
    for key, value in people_dict.items():
        ...
        print(value[NAME_INDEX], age_death)
...
def print_marriages(marriages_dict, people_dict):
    ...
    for key, value in marriages_dict.items():
        ...
        husband_age_wegging = wedding_year - husband[BIRTH_YEAR_INDEX]
        wife_name = wife[NAME_INDEX]
        wife_age_wegging = wedding_year - wife[BIRTH_YEAR_INDEX]

        print(f'{husband_name} {husband_age_wegging} > {wedding_year} < {wife_name} {wife_age_wegging}')
