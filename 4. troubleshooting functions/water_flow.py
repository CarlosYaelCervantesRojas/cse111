def water_column_height(tower_height, tank_height):
    """Calculates and returns the height of a column of waterfrom a tower height and a tank wall height.
    Parameters
        tower_height: a number
        tank_height: another number
    Return: a number
    """
...
def pressure_loss_from_pipe(pipe_diameter, pipe_length, friction_factor, fluid_velocity):
    ...
    Parameters
        pipe_diameter: a number
        pipe_length: another number
        friction_factor: another number
        fluid_velocity: another number
    Return: a number
    """
...
def pressure_loss_from_fittings(fluid_velocity, quantity_fittings):
    """calculates the water pressure lost because of fittings such as 45° and 90° bends that are in a pipeline.
     Parameters
        fluid_velocity: a number
        quantity_fittings: another number
    Return: a number
    """
...
def pressure_loss_from_pipe_reduction(larger_diameter, fluid_velocity, reynolds_number, smaller_diameter):
    ...
    Parameters
        larger_diameter: a number
        fluid_velocity: another number
        reynolds_number: another number
        smaller_diameter: another number
    Return: a number
    """
